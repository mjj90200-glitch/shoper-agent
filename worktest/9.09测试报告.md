...
![TC-005 历史会话消息完整内容与按钮可见性](9.09/tc-manual-tts-005_history_message_intact.png)
...
![TC-006 场景A：无效密钥，按钮旁局部报错且结果区完整](9.09/tc-manual-tts-006a_invalid_key_local_error.png)
...
![TC-006 场景B：断网等效，提示"暂时无法连接语音服务"](9.09/tc-manual-tts-006b_offline_local_error.png)

**场景 C：未配置密钥（补充场景）**

点击后局部显示"语音服务尚未配置 API Key。"（503），同样不影响已有内容与后续问数。

![TC-006 场景C：未配置密钥，局部 503 提示且结果/图表保留](9.09/tc-manual-tts-006_local_error_history_button.png)
